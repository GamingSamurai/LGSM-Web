...
--
ALTER TABLE `admin`
  MODIFY `cat_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
-- AUTO_INCREMENT for table `bots`
--
ALTER TABLE `bots`
  MODIFY `bot_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'index', AUTO_INCREMENT=1;
--
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `Session Cleanup` ON SCHEDULE EVERY 3 MINUTE STARTS '2015-01-25 23:08:18' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Session Cleanup' DO delete FROM sessions WHERE updated_on < (UNIX_TIMESTAMP() - 900)$$
