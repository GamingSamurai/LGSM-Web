...
$servers = array(
    ...
    'id' => 'pisspants',
    'type' =>'gmod', 
    'host' =>'37.122.211.130:27030'),
    array(
     'id' => 'mc1', 
     'type' => 'css', 
     'host' => '37.122.211.130:27017'),
     array(
     'id' => 'nmh',
     'type' =>'source',
     'host' => '37.122.211.130:27018',
     
     ),
     array(
     'id' => 'fof',
     'type' =>'source',
     'host' => '37.122.211.130:27016',
     
     ),
     array(
     'id' => 'tf2',
     'type' =>'tf2',
     'host' => '37.122.211.130:27043',
     
     ),
     array(
     'id' => 'css',
     'type' =>'css',
     'host' => '37.122.211.130:27015',
...
$gq->setOption('timeout', 200); // Seconds
...
print_r($results);
echo '<br><br>';
$test =$results['fof']['players']; // grab the players array out
print_r ($test);
